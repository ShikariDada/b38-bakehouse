  ...
  return (
    <div className="mx-auto max-w-6xl px-4 sm:px-6 pt-[calc(var(--header-h)+2rem)]">
      <div className="grid md:grid-cols-[45%_55%] gap-10 items-start">
        <div>
          <p className="eyebrow text-cocoa-600">About</p>
          <h1 className="display display-lg mt-2">A kitchen, not a factory</h1>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link href="/designs" className="btn btn-cocoa">See the designs</Link>
          ...
          <address className="mt-8 not-italic num text-[0.92rem] text-ink-soft">
            {s.address}<br />
            <a className="underline underline-offset-2 hover:text-cocoa-700" href={s.mapsLink} target="_blank" rel="noopener">Directions</a>
            {" · "}
            <a className="underline underline-offset-2 hover:text-cocoa-700" href={`tel:+${s.whatsapp}`}>{s.phoneDisplay}</a>
          </address>
        </div>

        <div className="grid grid-cols-2 gap-3 sm:gap-4">
          <div className="relative rounded-[4px] overflow-hidden bg-cream-200" style={{ aspectRatio: "4/5" }}>
          ...
          <div className="relative rounded-[4px] overflow-hidden bg-cream-200 mt-8" style={{ aspectRatio: "4/5" }}>
            <Image src="/media/hero/macro-petals.webp" alt="Hand-piped petals" fill sizes="(max-width:768px) 46vw, 26vw" className="object-cover" />
          </div>
          <div className="relative rounded-[4px] overflow-hidden bg-cream-200 -mt-2" style={{ aspectRatio: "4/5" }}>
            <Image src="/media/hero/macro-drip.webp" alt="Ganache drip detail" fill sizes="(max-width:768px) 46vw, 26vw" className="object-cover" />
          </div>
          <div className="relative rounded-[4px] overflow-hidden bg-cream-200 mt-6" style={{ aspectRatio: "4/5" }}>
